...
class GensetReport extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'water_fuel_level_ok_ACTION' => 'Action',
			'water_fuel_level_ok_ACTION_DATE' => 'Action Date',
			...
			'double_genset_automation_working_ACTION' => 'Action',
			'double_genset_automation_working_ACTION_DATE' => 'Action Date',
			...
			'test_auto_start_by_switching_off_mains_ACTION' => 'Action',
			'test_auto_start_by_switching_off_mains_ACTION_DATE' => 'Action Date',
			...
			'exhaust_system_broken_noisy_lagging_ACTION' => 'Action',
			'exhaust_system_broken_noisy_lagging_ACTION_DATE' => 'Action Date',
			...
			'check_engine_cranking_battery_water_cables_ACTION' => 'Action',
			'check_engine_cranking_battery_water_cables_ACTION_DATE' => 'Action Date',
			...
			'fuel_theft_leakage_ACTION' => 'Action',
			'fuel_theft_leakage_ACTION_DATE' => 'Action Date',

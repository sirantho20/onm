...
class ContainerReport extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'report_id' => 'Report',
			'door_locking_working' => 'Door Locking Working',
			'door_locking_working_ACTION' => 'Door Locking Working Action',
			'door_locking_working_ACTION_DATE' => 'Door Locking Working Action Date',
			'door_locking_working_FS_COMMENT' => 'Door Locking Working Fs Comment',
			'external_security_light_working' => 'External Security Light Working',
			'external_security_light_working_ACTION' => 'External Security Light Working Action',
			'external_security_light_working_ACTION_DATE' => 'External Security Light Working Action Date',
			'external_security_light_working_FS_COMMENT' => 'External Security Light Working Fs Comment',
			'internal_lights_wall_sockets_working' => 'Internal Lights Wall Sockets Working',
			'internal_lights_wall_sockets_working_ACTION' => 'Internal Lights Wall Sockets Working Action',
			'internal_lights_wall_sockets_working_ACTION_DATE' => 'Internal Lights Wall Sockets Working Action Date',
			'internal_lights_wall_sockets_working_FS_COMMENT' => 'Internal Lights Wall Sockets Working Fs Comment',
			'fire_extinguisher_on_site' => 'Fire Extinguisher On Site',
			'fire_extinguisher_on_site_ACTION' => 'Fire Extinguisher On Site Action',
			'fire_extinguisher_on_site_ACTION_DATE' => 'Fire Extinguisher On Site Action Date',
			'fire_extinguisher_on_site_FS_COMMENT' => 'Fire Extinguisher On Site Fs Comment',
			'inside_container_neat_tidy' => 'Inside Container Neat Tidy',
			'inside_container_neat_tidy_ACTION' => 'Inside Container Neat Tidy Action',
			'inside_container_neat_tidy_ACTION_DATE' => 'Inside Container Neat Tidy Action Date',
			'inside_container_neat_tidy_FS_COMMENT' => 'Inside Container Neat Tidy Fs Comment',
			'water_insect_intering_container' => 'Water Insect Intering Container',
			'water_insect_intering_container_ACTION' => 'Water Insect Intering Container Action',
			'water_insect_intering_container_ACTION_DATE' => 'Water Insect Intering Container Action Date',
			'water_insect_intering_container_FS_COMMENT' => 'Water Insect Intering Container Fs Comment',
			'site_log_book_in_container' => 'Site Log Book In Container',
			'site_log_book_in_container_ACTION' => 'Site Log Book In Container Action',
			'site_log_book_in_container_ACTION_DATE' => 'Site Log Book In Container Action Date',
			'site_log_book_in_container_FS_COMMENT' => 'Site Log Book In Container Fs Comment',
			'ac_units_working_correctly' => 'Ac Units Working Correctly',
			'ac_units_working_correctly_ACTION' => 'Ac Units Working Correctly Action',
			'ac_units_working_correctly_ACTION_DATE' => 'Ac Units Working Correctly Action Date',
			'ac_units_working_correctly_FS_COMMENT' => 'Ac Units Working Correctly Fs Comment',
			'ac_serviced' => 'Ac Serviced',
			'ac_serviced_ACTION' => 'Ac Serviced Action',
			'ac_serviced_ACTION_DATE' => 'Ac Serviced Action Date',
			'ac_serviced_FS_COMMENT' => 'Ac Serviced Fs Comment',
			'ac_serviced_DATE' => 'Ac Serviced Date',
			'ac_air_filter_clean' => 'Ac Air Filter Clean',
			'ac_air_filter_clean_ACTION' => 'Ac Air Filter Clean Action',
			'ac_air_filter_clean_ACTION_DATE' => 'Ac Air Filter Clean Action Date',
			'ac_air_filter_clean_FS_COMMENT' => 'Ac Air Filter Clean Fs Comment',
			'bts_internal_external_alarms' => 'Bts Internal External Alarms',
			'bts_internal_external_alarms_ACTION' => 'Bts Internal External Alarms Action',
